...
class SampleDataGenerator {
    ...
    companion object {
        ...
        fun getProducts(context:Context): List<Product>{
            ...
            return listOf(
                Product("Wool Blanket", "RM 30", "55% recycled wool, 30% recycled polyester, 15% recycled other fibres. For every blanket sold, we donate RM15 to the Asylum Seeker Resource Centre", 20,  bitmapList[0], 1,  1),
                Product("Yoga Mat", "RM 40", "95% Recycled Mat. For every yoga mat sold, we donate RM20 to the Asylum Seeker Resource Centre", 20,  bitmapList[1], 2,  1),
                Product("Toothbrush", "RM 25", "99% recycled Toothbrush. For every toothbrush sold, we donate RM10 to the Asylum Seeker Resource Centre", 40,  bitmapList[2], 1,  2),
                Product("Tote Bag", "RM 30", "85% recycled Tote Bag. For every toothbrush sold, we donate RM15 to the Asylum Seeker Resource Centre", 30,  bitmapList[3], 3,  3),
                Product("Wallet", "RM 30", "80% recycled Wallet. For every wallet sold, we donate RM15 to the Asylum Seeker Resource Centre", 35,  bitmapList[4], 3,  3),
                Product("Steel Bottle", "RM 50", "80% recycled Steel Bottle. For every bottle sold, we donate RM25 to the Asylum Seeker Resource Centre", 20,  bitmapList[5], 2,  4)
            )
        }
